...
namespace DocsMarshal.Connectors.Entities
{
    public class Profile : Interfaces.IProfile
    {
        ...
        private Field GetField_By_ExternalId(string ExternalId, DocsMarshal.Connectors.Entities.Enums.EFieldType Type)
        {
        ...
        private Field GetField_By_Id(int Id, DocsMarshal.Connectors.Entities.Enums.EFieldType Type)
        {
        ...
        public string GetMultilanguageFieldValueById(int id, int languegeId)
        {
            ...
            if (Field.GenericValue != null)
            {
                var fieldContent =JsonConvert.DeserializeObject<List<DocsMarshal.Connectors.Entities.FieldValueLang>>(Field.GenericValue.ToString());
