...
{
    public class UrlsManager : DocsMarshal.Connectors.Interfaces.Managers.Portal.IUrlsManager
    {
        private Manager Orchestrator = null;

        public UrlsManager(DocsMarshal.Connectors.Orchestrator.Manager manager)
        {
