...
{
    public class ProfileSearchManager: DocsMarshal.Connectors.Interfaces.Managers.Profile.IProfileSearchManager
    {
        private Manager Orchestrator = null;

        public ProfileSearchManager(DocsMarshal.Connectors.Orchestrator.Manager manager)
        {
        ...
        private class Root
        {
            ...
            public DocsMarshal.Connectors.Entities.Profile[] Profiles { get; set; }
