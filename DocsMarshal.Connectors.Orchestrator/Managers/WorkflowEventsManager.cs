...
{
    public class WorkflowEventsManager : DocsMarshal.Connectors.Interfaces.Managers.Workflow.IWorkflowEvents
    {
        private DocsMarshal.Connectors.Orchestrator.Manager Orchestrator;

        public WorkflowEventsManager(DocsMarshal.Connectors.Orchestrator.Manager orchestrator)
        {
