...
namespace DocsMarshal.MVVM.Models
{
    public class BaseModelEntity:INotifyPropertyChanged
    {
        ...
        public void LoadStandardFieldFromProfileSearchResult(DocsMarshal.Connectors.Entities.Interfaces.IProfile profile)
        {
        ...
        internal void AddStdFieldToIProfileFor(DocsMarshal.Connectors.Entities.Interfaces.IProfileFor profileFor, bool raiseWorkflowEvents)
        {
        ...
        public DocsMarshal.Connectors.Entities.ProfileForInsert ToProfileForInsert(bool raiseWorkflowEvents)
        {
            var ritorno = new DocsMarshal.Connectors.Entities.ProfileForInsert();
            ritorno.ClassTypeExternalID = ClassTypeExternalId;
            AddStdFieldToIProfileFor(ritorno, raiseWorkflowEvents);
            return ritorno;
        }

        public DocsMarshal.Connectors.Entities.ProfileForUpdate ToProfileForUpdate(bool raiseWorkflowEvents)
        {
            var ritorno = new DocsMarshal.Connectors.Entities.ProfileForUpdate();
