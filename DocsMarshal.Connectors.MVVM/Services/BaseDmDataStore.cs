...
namespace DocsMarshal.MVVM.Services
{
    public abstract class BaseDmDataStore<T> : IDataStore<T> where T : Models.BaseModelEntity, new()
    {
        ...
        public abstract void Filler(DocsMarshal.Connectors.Entities.ProfileForBase profileFor, T model);
        ...
        protected DocsMarshal.Connectors.Interfaces.IManager Orchestrator { get; private set; }
        ...
        public BaseDmDataStore(DocsMarshal.Connectors.Interfaces.IManager orchestrator, string classTypeExternalId) : this(orchestrator, classTypeExternalId, true, false)
        {
        }

        public BaseDmDataStore(DocsMarshal.Connectors.Interfaces.IManager orchestrator, string classTypeExternalId, bool domainOriented, bool manageContentByLanguage)
        {
        ...
        private DocsMarshal.Connectors.Entities.ProfileForInsert FromEntityToProfileForInsert(T model, bool raiseWorkflowEvents)
        {
        ...
        private DocsMarshal.Connectors.Entities.ProfileForUpdate FromEntityToProfileForUpdate(T model, bool raiseWorkflowEvents)
        {
        ...
        protected virtual void SetDefaultSearchParams(DocsMarshal.Connectors.Entities.ProfileSearch search)
        {
        ...
        protected virtual async Task<IEnumerable<T>> GetItemsAsync(DocsMarshal.Connectors.Entities.ProfileSearch ricerca, bool forceRefresh = false, bool useCache = true)
        {
            ...
            if (ricerca == null)
                ricerca = new Connectors.Entities.ProfileSearch();
